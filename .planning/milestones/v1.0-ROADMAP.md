...
- [x] 02-02-PLAN.md -- Card input UI: CardFace, CardPicker, HandDisplay, PlayerPanel, PlayerToggle, validation (CARD-01, CARD-02, CARD-03, CARD-04, CARD-05)
...
Plans:
- [x] 03-01-PLAN.md -- Foundation: install dependencies, game state reconstruction, simulation path extraction, tab system, store extension (RSLT-03, TREE-03, SIM-01)
...
- [x] 03-03-PLAN.md -- Step-by-step simulation: step display, opponent responses, navigation controls, auto-play, framer-motion animations (SIM-01, SIM-02, SIM-03, SIM-04)
